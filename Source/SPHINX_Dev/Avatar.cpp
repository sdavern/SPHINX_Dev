...
void AAvatar::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		/* // Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AAvatar::Look); */
	}
	else
	{
...
void AAvatar::Move(const FInputActionValue& Value)
{
	...
	if (Controller != nullptr)
	{
		...
		AddMovementInput(GetActorRightVector(), MovementVector.Y * -1);
	}
}

/* void AAvatar::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
