...
// End Cross Module References
	DEFINE_FUNCTION(URule::execCalcCosineSim)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		*(double*)Z_Param__Result=P_THIS->CalcCosineSim();
		P_NATIVE_END;
	}
	...
	DEFINE_FUNCTION(URule::execContainsItemRespawn)
	{
		P_GET_OBJECT(UItem,Z_Param_Item);
		P_FINISH;
		P_NATIVE_BEGIN;
		*(bool*)Z_Param__Result=P_THIS->ContainsItemRespawn(Z_Param_Item);
		P_NATIVE_END;
	}
	...
	void URule::StaticRegisterNativesURule()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "CalcCosineSim", &URule::execCalcCosineSim },
			{ "Clone", &URule::execClone },
			{ "ContainsItem", &URule::execContainsItem },
			{ "ContainsItemRespawn", &URule::execContainsItemRespawn },
	...
	struct Z_Construct_UFunction_URule_CalcCosineSim_Statics
	{
		struct Rule_eventCalcCosineSim_Parms
		{
			double ReturnValue;
		};
	...
	const UECodeGen_Private::FDoublePropertyParams Z_Construct_UFunction_URule_CalcCosineSim_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Double, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(Rule_eventCalcCosineSim_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_URule_CalcCosineSim_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_URule_CalcCosineSim_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_URule_CalcCosineSim_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Rule.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URule_CalcCosineSim_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URule, nullptr, "CalcCosineSim", nullptr, nullptr, Z_Construct_UFunction_URule_CalcCosineSim_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URule_CalcCosineSim_Statics::PropPointers), sizeof(Z_Construct_UFunction_URule_CalcCosineSim_Statics::Rule_eventCalcCosineSim_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URule_CalcCosineSim_Statics::Function_MetaDataParams), Z_Construct_UFunction_URule_CalcCosineSim_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_URule_CalcCosineSim_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_URule_CalcCosineSim_Statics::Rule_eventCalcCosineSim_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_URule_CalcCosineSim()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_URule_CalcCosineSim_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	struct Z_Construct_UFunction_URule_ContainsItemRespawn_Statics
	{
		struct Rule_eventContainsItemRespawn_Parms
		{
			UItem* Item;
			bool ReturnValue;
		};
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_URule_ContainsItemRespawn_Statics::NewProp_Item = { "Item", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(Rule_eventContainsItemRespawn_Parms, Item), Z_Construct_UClass_UItem_NoRegister, METADATA_PARAMS(0, nullptr) };
	void Z_Construct_UFunction_URule_ContainsItemRespawn_Statics::NewProp_ReturnValue_SetBit(void* Obj)
	{
		((Rule_eventContainsItemRespawn_Parms*)Obj)->ReturnValue = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_URule_ContainsItemRespawn_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(Rule_eventContainsItemRespawn_Parms), &Z_Construct_UFunction_URule_ContainsItemRespawn_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_URule_ContainsItemRespawn_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_URule_ContainsItemRespawn_Statics::NewProp_Item,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_URule_ContainsItemRespawn_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_URule_ContainsItemRespawn_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Rule.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_URule_ContainsItemRespawn_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URule, nullptr, "ContainsItemRespawn", nullptr, nullptr, Z_Construct_UFunction_URule_ContainsItemRespawn_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URule_ContainsItemRespawn_Statics::PropPointers), sizeof(Z_Construct_UFunction_URule_ContainsItemRespawn_Statics::Rule_eventContainsItemRespawn_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_URule_ContainsItemRespawn_Statics::Function_MetaDataParams), Z_Construct_UFunction_URule_ContainsItemRespawn_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_URule_ContainsItemRespawn_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_URule_ContainsItemRespawn_Statics::Rule_eventContainsItemRespawn_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_URule_ContainsItemRespawn()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_URule_ContainsItemRespawn_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_InputsVector_MetaData[];
#endif
		static const UECodeGen_Private::FStructPropertyParams NewProp_InputsVector;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_OutputsVector_MetaData[];
#endif
		static const UECodeGen_Private::FStructPropertyParams NewProp_OutputsVector;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_Similarity_MetaData[];
#endif
		static const UECodeGen_Private::FDoublePropertyParams NewProp_Similarity;
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_URule_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_URule_CalcCosineSim, "CalcCosineSim" }, // 971583447
		{ &Z_Construct_UFunction_URule_Clone, "Clone" }, // 131246586
		{ &Z_Construct_UFunction_URule_ContainsItem, "ContainsItem" }, // 1742011
		{ &Z_Construct_UFunction_URule_ContainsItemRespawn, "ContainsItemRespawn" }, // 1921663788
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_URule_Statics::NewProp_InputsVector_MetaData[] = {
		{ "ModuleRelativePath", "Rule.h" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_URule_Statics::NewProp_InputsVector = { "InputsVector", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URule, InputsVector), Z_Construct_UScriptStruct_FVector7D, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URule_Statics::NewProp_InputsVector_MetaData), Z_Construct_UClass_URule_Statics::NewProp_InputsVector_MetaData) }; // 2389293912
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_URule_Statics::NewProp_OutputsVector_MetaData[] = {
		{ "ModuleRelativePath", "Rule.h" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_URule_Statics::NewProp_OutputsVector = { "OutputsVector", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URule, OutputsVector), Z_Construct_UScriptStruct_FVector7D, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URule_Statics::NewProp_OutputsVector_MetaData), Z_Construct_UClass_URule_Statics::NewProp_OutputsVector_MetaData) }; // 2389293912
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_URule_Statics::NewProp_Similarity_MetaData[] = {
		{ "ModuleRelativePath", "Rule.h" },
	};
#endif
	const UECodeGen_Private::FDoublePropertyParams Z_Construct_UClass_URule_Statics::NewProp_Similarity = { "Similarity", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Double, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(URule, Similarity), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_URule_Statics::NewProp_Similarity_MetaData), Z_Construct_UClass_URule_Statics::NewProp_Similarity_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_URule_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_URule_Statics::NewProp_InputsVector,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_URule_Statics::NewProp_OutputsVector,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_URule_Statics::NewProp_Similarity,
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_valey_Documents_Unreal_Projects_SPHINX_Dev_Source_SPHINX_Dev_Rule_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_URule, URule::StaticClass, TEXT("URule"), &Z_Registration_Info_UClass_URule, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URule), 3135063408U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_valey_Documents_Unreal_Projects_SPHINX_Dev_Source_SPHINX_Dev_Rule_h_453755899(TEXT("/Script/SPHINX_Dev"),
