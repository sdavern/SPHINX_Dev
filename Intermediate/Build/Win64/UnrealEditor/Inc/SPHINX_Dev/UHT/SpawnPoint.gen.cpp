...
// End Cross Module References
	DEFINE_FUNCTION(ASpawnPoint::execCheckForItem)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->CheckForItem();
	...
	DEFINE_FUNCTION(ASpawnPoint::execToSpawnPropPtrs)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->ToSpawnPropPtrs();
		P_NATIVE_END;
	}
	...
	void ASpawnPoint::StaticRegisterNativesASpawnPoint()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			{ "CheckForItem", &ASpawnPoint::execCheckForItem },
			{ "GetLocation", &ASpawnPoint::execGetLocation },
			{ "ToSpawnPropPtrs", &ASpawnPoint::execToSpawnPropPtrs },
		};
		FNativeFunctionRegistrar::RegisterFunctions(Class, Funcs, UE_ARRAY_COUNT(Funcs));
	}
	struct Z_Construct_UFunction_ASpawnPoint_CheckForItem_Statics
	{
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ASpawnPoint_CheckForItem_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "SpawnPoint.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ASpawnPoint_CheckForItem_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ASpawnPoint, nullptr, "CheckForItem", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ASpawnPoint_CheckForItem_Statics::Function_MetaDataParams), Z_Construct_UFunction_ASpawnPoint_CheckForItem_Statics::Function_MetaDataParams) };
	UFunction* Z_Construct_UFunction_ASpawnPoint_CheckForItem()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ASpawnPoint_CheckForItem_Statics::FuncParams);
		}
	...
	struct Z_Construct_UFunction_ASpawnPoint_ToSpawnPropPtrs_Statics
	{
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ASpawnPoint_ToSpawnPropPtrs_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "SpawnPoint.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ASpawnPoint_ToSpawnPropPtrs_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ASpawnPoint, nullptr, "ToSpawnPropPtrs", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ASpawnPoint_ToSpawnPropPtrs_Statics::Function_MetaDataParams), Z_Construct_UFunction_ASpawnPoint_ToSpawnPropPtrs_Statics::Function_MetaDataParams) };
	UFunction* Z_Construct_UFunction_ASpawnPoint_ToSpawnPropPtrs()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ASpawnPoint_ToSpawnPropPtrs_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	struct Z_Construct_UClass_ASpawnPoint_Statics
	{
		...
		static const UECodeGen_Private::FObjectPropertyParams NewProp_PropPtrs_Inner;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_PropPtrs_MetaData[];
#endif
		static const UECodeGen_Private::FArrayPropertyParams NewProp_PropPtrs;
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ASpawnPoint_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ASpawnPoint_CheckForItem, "CheckForItem" }, // 233403279
		{ &Z_Construct_UFunction_ASpawnPoint_GetLocation, "GetLocation" }, // 2914250082
		{ &Z_Construct_UFunction_ASpawnPoint_ToSpawnPropPtrs, "ToSpawnPropPtrs" }, // 1387806598
	};
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ASpawnPoint_Statics::NewProp_SphereRadius_MetaData[] = {
		{ "Category", "SpawnPoint" },
		{ "ModuleRelativePath", "SpawnPoint.h" },
	};
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ASpawnPoint_Statics::NewProp_SphereRadius = { "SphereRadius", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ASpawnPoint, SphereRadius), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ASpawnPoint_Statics::NewProp_SphereRadius_MetaData), Z_Construct_UClass_ASpawnPoint_Statics::NewProp_SphereRadius_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ASpawnPoint_Statics::NewProp_PropPtrs_Inner = { "PropPtrs", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UItemProperty_NoRegister, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ASpawnPoint_Statics::NewProp_PropPtrs_MetaData[] = {
		{ "ModuleRelativePath", "SpawnPoint.h" },
	};
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_ASpawnPoint_Statics::NewProp_PropPtrs = { "PropPtrs", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ASpawnPoint, PropPtrs), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ASpawnPoint_Statics::NewProp_PropPtrs_MetaData), Z_Construct_UClass_ASpawnPoint_Statics::NewProp_PropPtrs_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ASpawnPoint_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ASpawnPoint_Statics::NewProp_SphereRadius,
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ASpawnPoint_Statics::NewProp_PropPtrs_Inner,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ASpawnPoint_Statics::NewProp_PropPtrs,
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_valey_Documents_Unreal_Projects_SPHINX_Dev_Source_SPHINX_Dev_SpawnPoint_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ASpawnPoint, ASpawnPoint::StaticClass, TEXT("ASpawnPoint"), &Z_Registration_Info_UClass_ASpawnPoint, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ASpawnPoint), 66165271U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_valey_Documents_Unreal_Projects_SPHINX_Dev_Source_SPHINX_Dev_SpawnPoint_h_3669734347(TEXT("/Script/SPHINX_Dev"),
