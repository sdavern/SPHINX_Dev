...
// End Cross Module References
	...
	struct Z_Construct_UClass_UArea_Statics
	{
		...
		static const UECodeGen_Private::FClassPropertyParams NewProp_GoalsBP_Inner;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_GoalsBP_MetaData[];
#endif
		static const UECodeGen_Private::FArrayPropertyParams NewProp_GoalsBP;
	...
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_UArea_Statics::NewProp_GoalsBP_Inner = { "GoalsBP", nullptr, (EPropertyFlags)0x0004000000000000, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UClass, Z_Construct_UClass_UTerm_NoRegister, METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UArea_Statics::NewProp_GoalsBP_MetaData[] = {
		{ "Category", "Area" },
		{ "ModuleRelativePath", "Area.h" },
	};
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UArea_Statics::NewProp_GoalsBP = { "GoalsBP", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UArea, GoalsBP), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UArea_Statics::NewProp_GoalsBP_MetaData), Z_Construct_UClass_UArea_Statics::NewProp_GoalsBP_MetaData) };
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UArea_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UArea_Statics::NewProp_GoalsBP_Inner,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UArea_Statics::NewProp_GoalsBP,
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_valey_Documents_Unreal_Projects_SPHINX_Dev_Source_SPHINX_Dev_Area_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UArea, UArea::StaticClass, TEXT("UArea"), &Z_Registration_Info_UClass_UArea, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UArea), 3558006739U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_valey_Documents_Unreal_Projects_SPHINX_Dev_Source_SPHINX_Dev_Area_h_3793591042(TEXT("/Script/SPHINX_Dev"),
